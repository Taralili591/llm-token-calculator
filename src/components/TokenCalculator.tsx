    ...
    <div className="calculator">
      <section className="card">
        ...
        <div className="provider-scroll">
          {ALL_PROVIDERS.map((p) => (
            ...
            >
              {p === "all" ? allLabel : (PROVIDER_LABELS[p] ?? p)}
            </button>
          ))}
        </div>

        <h2 style={{ marginTop: "1rem" }}>{t.modelLabel}</h2>
            ...
            >
              ...
              <div className="model-prices">
                {model.inputPricePer1M === 0 && model.outputPricePer1M === 0 ? (
                  <span className="varies">{model.note ?? t.varies}</span>
                ) : (
                  <>
      ...
      <section className="card text-section">
        <div className="text-col">
          ...
          <textarea
            placeholder={lang === "zh" ? "在此粘贴你的 prompt 或输入文本…" : "Paste your prompt or input text here..."}
            value={inputText}
        ...
        <div className="text-col">
          ...
          <textarea
            placeholder={lang === "zh" ? "在此粘贴预期或示例输出…" : "Paste expected or sample output here..."}
            value={outputText}
      ...
      <section className="card results">
        <h2>
          {t.costEstimate} — {selectedModel.name}
